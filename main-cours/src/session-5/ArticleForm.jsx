    ...
    <>
      <fieldset className="table-container p-4">
        ...
        <div className="form-row">
          ...
          <input
            ...
            className="bg-gray-50 w-48 border"
            onChange={(e) =>
              setArticle({ ...article, quantite: e.target.value })
            }
          />
        </div>
        ...
        <div className="form-row">
          ...
          <select
            ...
            onChange={(e) =>
              setArticle({ ...article, idCategorie: e.target.value })
            }
        ...
        <button id="ajouter" onClick={handleAjouter}>
          Ajouter
        </button>
      </fieldset>
      ...
      <div className="table-container">
        ...
        <div className="py-3">
          ...
          <button className="btn-modifier" onClick={modifier}>
            modifier
          </button>
        </div>
      </div>
